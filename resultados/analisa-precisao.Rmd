...
model_erro_lex_adj_op30 = lm(erro_usual ~  quant_adj_op30 + palavras, data=lexico_op30)
...
model_erro_lex_adj_sent = lm(erro_usual ~  quant_adj_op30 + palavras, data=lexico_sent)
