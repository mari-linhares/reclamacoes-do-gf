...
```
###Porcentagem de palavras identificadas pelo lexico

No gráfico abaixo verificamos a relação entre a porcentagem de palavras identificadas pelo lexico em relação ao número total (eixo x) e a quantidade de reclamações com essa porcentagem (eixo y). 

```{r, fig.width = 12, fig.height = 10}
ggplot(data=lexico_op30, aes(lexico_op30$palavras_sent/palavras)) + 
